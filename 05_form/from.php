									...
									<div class="dropdown nav-item main-header-notification">
										...
										<div class="dropdown-menu">
											...
											<div class="main-notification-list Notification-scroll">
												...
												<a class="d-flex p-3 border-bottom"   href="javasc -ript:void(0);">
						...
						<div class="main-sidebar-loggedin">
							<div class="app-sidebar__user">
								<div class="dropdown user-pro-body text-center">
									<div class="user-pic">
										<img src="poto opey.jpg" alt="user-img" class="rounded-circle mCS_img_loaded">
									</div>
									<div class="user-info">
										<h6 class=" mb-0 text-dark">Loveianan</h6>
								...
								<div class="ps-0">
									<div class="main-profile-overview">
										<div class="main-img-user profile-user">
											<img alt="" src="poto opey.jpg"><a class="fas fa-camera profile-edit" href="JavaScript:void(0);"></a>
										</div>
										<div class="d-flex justify-content-between mg-b-20">
											<div>
												<h5 class="main-profile-name">Loveiana</h5>
											</div>
										</div>
										<h6>Bio</h6>
										<div class="main-profile-bio">
											Jatuh cinta ko sendirian, yaa kasian...
										...
										<div class="main-profile-social-list">
											...
											<div class="media">
												<div class="media-icon bg-success-transparent text-success">
													<img src="free fire.jpg">
												</div>
												<div class="media-body">
													<span>Free Fire</span> <a href="">opeyGemas</a>
												</div>
											</div>
								...
								<div class="wideget-user-tab">
									<div class="tab-menu-heading">
										<div class="tabs-menu1">
											<ul class="nav">
												<li class=""><a href="#tab-51" class="active show" data-bs-toggle="tab">hasil</a></li>
											</ul>
										</div>
									</div>
								</div>
												...
												<div class="card-header">
													<div class="media">
														<div class="media-user me-2">
															<div class="main-img-user avatar-md"><img alt="" class="rounded-circle" src="poto opey.jpg "></div>
														</div>
														<div class="media-body">
															<h6 class="mb-0 mg-t-9">form</h6>
														</div>
														<div class="ms-auto">
